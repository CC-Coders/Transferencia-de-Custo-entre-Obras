...
<body> -->
    <div id="wdgTransfCusto_${instanceId}" class="super-widget wcm-widget-class fluig-style-guide"
        ...
        <div id="filtros" class="panel panel-primary" style="border-radius: 20px;">
            <div class="panel-heading" style="text-align: center;border-radius: 20px;" >
                <h1 class="" style="font-weight: bolder; margin: 0px;">
                    <i class="flaticon flaticon-chevron-up icon-lg" aria-hidden="true" id="arrowFiltro"></i>
                    FILTROS
                </h1>
            </div>
        ...
        <div>
            <div class="row flexRow" >
                ...
                <div class="col-md-3">
                    <div class="card card-castilho" style="background-color: #58595b !important; height: 80%; background: #58595b; color: white !important;">
                        <div class="card-body" style="background-color: #58595b; display: flex; justify-content: center; align-items: center;">
                                <h3 class="card-title">
        ...
        <div>
            <table class="table table-striped" id="tableTransferencias">
                <thead>
                    <tr>
                        <th></th>
                        <th>Solicitação</th>
